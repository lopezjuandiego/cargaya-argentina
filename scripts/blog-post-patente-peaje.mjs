...
const title = "Patente y peajes para autos eléctricos en Buenos Aires: todo lo que ahorrás en 2026";
const slug = "exencion-patente-peaje-autos-electricos-buenos-aires-2026";
const excerpt = "En CABA, los autos eléctricos no pagan patente ni peaje. En Provincia de Buenos Aires tampoco pagan patente. Te explicamos qué está exento, hasta cuándo aplica, cómo tramitarlo y cuánto ahorrás por año.";
...
Esta guía te explica exactamente qué aplica en cada jurisdicción, qué condiciones hay que cumplir, cómo tramitar los beneficios y cuánto representan en plata real.

> **Resumen rápido**
>
> - **Autos eléctricos en CABA:** exentos del 100% de la patente sin importar precio ni antigüedad; tampoco pagan peaje en autopistas de la ciudad
> - **Autos eléctricos en Provincia de Buenos Aires:** exentos del 100% de la patente
> - **Autos híbridos en CABA:** exentos los primeros 1–2 años, luego pagan de forma gradual según su valuación
> - **Peajes híbridos en CABA:** 50% de descuento en autopistas urbanas
...
La "patente" es el nombre popular del **impuesto automotor**, un tributo anual (o bimestral, según la jurisdicción) que aplica sobre la tenencia de un vehículo. No confundir con el **patentamiento**, que es el trámite único de inscripción cuando comprás el auto — ese sí tiene un costo puntual.
...
### Autos 100% eléctricos: exención total y permanente

Los autos eléctricos puros están **completamente exentos del impuesto automotor en CABA**. La exención no tiene límite de valuación fiscal, no tiene límite de antigüedad del vehículo y no vence por el paso del tiempo.

No importa si tu Tesla cuesta USD 80.000 o si tu BYD Dolphin Mini cuesta USD 22.000: en ambos casos, **patente cero**.

Esto está establecido por la **Ley 6825/2024** y administrado por la AGIP (Administración Gubernamental de Ingresos Públicos de la Ciudad). El beneficio aplica a todos los vehículos con propulsión exclusivamente eléctrica, sin excepción.

### Autos híbridos: régimen escalonado desde 2025

Para los híbridos (HEV, PHEV y MHEV), el esquema cambió en 2025. Ya no aplica la exención indefinida: ahora hay un sistema progresivo que depende de la **valuación fiscal del vehículo al momento del patentamiento**.
...
### Autos eléctricos: exención total
...
El beneficio rige en **todas las autopistas y autovías de la Ciudad de Buenos Aires** operadas bajo concesión, incluyendo:
...
El beneficio **no es automático**: hay que tramitarlo una sola vez y renovarlo anualmente.

**Requisitos:**
1. Tener el auto inscripto en **TelePASE** (el sistema de peaje electrónico)
2. Presentar la **cédula verde** del vehículo

**Dónde tramitarlo:**
Oficinas de **AUSA** (Autopistas Urbanas S.A.), ubicadas en:
- **Dellepiane y Piedras**, Parque Avellaneda — es el punto principal habilitado para este trámite

**Vigencia:** el beneficio dura **un año** y hay que renovarlo si el gobierno decide extenderlo. Hasta agosto de 2026 está confirmado.

> Si todavía no tenés TelePASE, podés registrarte en telepase.com.ar. Es gratuito y necesario para acceder al descuento.

---

## El patentamiento inicial: ¿tiene descuentos para eléctricos?

Acá viene la distinción importante: **el patentamiento** (la primera inscripción del auto cuando lo comprás) **no tiene descuentos especiales por ser eléctrico**. El costo es el mismo que para cualquier auto:
...
**Qué documentación necesitás para patentar un auto eléctrico o híbrido:**

El proceso es idéntico al de cualquier auto convencional. El concesionario generalmente lo gestiona:

- DNI y CUIT/CUIL del comprador
- Factura de compra original
- Formulario 12 (verificación policial del vehículo)
- Certificado de fabricación o importación
- Solicitud Tipo 01 (nacional o importado)

**Novedad 2025:** desde febrero de 2025 existe el **Registro Único Virtual (RUV)**, que permite la inscripción 100% digital de vehículos 0 km, sin ir presencialmente al Registro del Automotor. Reduce los costos hasta un 20% y el trámite demora unas 48 horas.

---

## ¿Cuánto ahorrás por año?

Para ponerlo en perspectiva, tomemos un ejemplo concreto. Un **BYD Atto 3** tiene un valor de mercado de aproximadamente USD 28.000.

En una zona sin exención, el impuesto automotor anual rondaría el **3% del valor fiscal**, lo que puede representar entre $1.200.000 y $1.800.000 anuales (según actualización fiscal).

Con la exención de CABA o Provincia de Buenos Aires: **$0**.

Si además manejás habitualmente por autopistas de CABA y tenés 2 peajes diarios de ~$1.200 cada uno, son ~$870.000 anuales solo en peajes. Con la exención: **$0**.
...
|---|---|---|---|---|
| Exención patente | Total y permanente | 1–2 años según valuación | Total | 2 años |
| Exención peaje | Sí (autopistas CABA) | 50% (autopistas CABA) | No aplica | No aplica |
| Vence el beneficio | No | Sí (progresivo) | No | Sí (a los 2 años) |
| Trámite especial | No | No | No | No |

---

## Otros distritos del país con exenciones similares

Si bien esta guía se enfoca en Buenos Aires, vale saber que hay **al menos 13 distritos** en Argentina con exenciones totales o parciales para eléctricos e híbridos, entre ellos:
...
La tendencia nacional es clara: los beneficios fiscales para vehículos de bajas emisiones se están extendiendo.
...
La patente se tributa en la jurisdicción de radicación del vehículo, es decir, donde está inscripto. Si cambiás de jurisdicción, tenés que hacer el trámite de relocalización en el Registro del Automotor y la exención aplica según las reglas de la nueva jurisdicción.

### ¿La exención de peajes aplica en la autopista Buenos Aires–La Plata?

No. La Autopista Buenos Aires–La Plata es una concesión provincial, no urbana. La exención de CABA aplica solo en las autopistas dentro de la ciudad (AUSA). Para autopistas nacionales y provinciales, no hay exención vigente para eléctricos.

### ¿Necesito renovar la exención de patente cada año?

No. En CABA y en Provincia de Buenos Aires, la exención de patente para autos eléctricos es **automática**: no requiere trámite ni renovación. La única que hay que renovar anualmente es la del **peaje** en AUSA.
    ...
    if (err.message?.includes("duplicate")) {
      ...
      const rows = await sql`
        ...
        SET title = ${title}, excerpt = ${excerpt}, content = ${content},
            published = ${published}, "updatedAt" = NOW()
        WHERE slug = ${slug}
        RETURNING id, slug
      `;
